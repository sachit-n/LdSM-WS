...
int main(int argc, char* argv[])
{
    ...
    try 
    {
        ...
        options.add_options()
            ("n,nmax", "maximum number of nodes", 
cxxopts::value<int>()->default_value("2000"))
            ...
            ("path", "path of data set", 
cxxopts::value<string>()->default_value("../data2/wiki10/"))
            ("name", "name of data set", cxxopts::value<string>()->default_value("wiki10"))
            ("savelabel", "file name for saving labels", 
cxxopts::value<string>()->default_value("../results/wiki10.dat"))
            ("loadlabel", "file name for loading labels", 
cxxopts::value<string>()->default_value("../results/wiki10.dat"))
