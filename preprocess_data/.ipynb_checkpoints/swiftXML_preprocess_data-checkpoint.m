 function swiftXML_preprocess_data( trn_file, tst_file, inc_tst_X_Y_file, exc_tst_X_Y_file, frac)

    [trn_X_Xf, trn_X_Y] = read_data( trn_file );
	[tst_X_Xf, tst_X_Y] = read_data( tst_file );
